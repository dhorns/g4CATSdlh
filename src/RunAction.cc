...
RunAction::RunAction()
{
  ...
  // Creating ntuple
  //
  analysisManager->CreateNtuple("g4CATS", "Edep and TrackL");
...
void RunAction::BeginOfRunAction(const G4Run* /*run*/)
{
  ...
  // Open an output file
  //
  G4String fileName = "g4CATS.root";
  // Other supported output types:
  // G4String fileName = "g4CATS.csv";
  // G4String fileName = "g4CATS.hdf5";
  // G4String fileName = "g4CATS.xml";
